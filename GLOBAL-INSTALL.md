...
- Connection SSH au Mac mini sur VScode(IP : 192.168.10.50) -> mdp : digital   
- Connection SSH au raspberryPi sur VScode (pi@pi1) -> mdp : raspberry,  IP: 192.168.10.127  
- Connection SSH terminal Mac mini :  ssh [digital@192.168.10.50](mailto:digital@192.168.10.50) / mdp : digital  
